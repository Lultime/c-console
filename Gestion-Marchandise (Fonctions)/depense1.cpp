...
depense1::depense1(QWidget *parent) :
    QDialog(parent),
    ui(new Ui::depense1)
{
    ui->setupUi(this);
...
void depense1::on_pushButton_clicked()
{
 ...
 insert = QSqlQuery("INSERT INTO depense (motif, quantite,Date,compte,anne,mois,jour) values('"+motif+"','"+quantite+"','"+Date+"','"+Compte+"','"+ Anne+"','"+ mois+"','"+ Jour+"')");
...
void depense1::on_pushButton_3_clicked()
{
